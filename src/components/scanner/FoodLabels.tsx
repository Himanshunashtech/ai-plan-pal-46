    ...
    <>
      {items.map((item, index) => (
        ...
        >
          ...
          {/* Label pill */}
          <div
            className="absolute bg-white dark:bg-black rounded-full px-3 py-1.5 shadow-lg whitespace-nowrap"
            style={{
          ...
          >
            ...
            <span className="text-xs text-muted-foreground dark:text-gray-400 ml-1">{item.calories}</span>
          </div>
        </div>
      ))}
    </>
